...
public class CourseV2 {
    ...
    public CourseV2 setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CourseV2 setUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
    ...
    public CourseV2 setExternalId(String externalId) {
    ...
    public CourseV2 setDataSourceId(String dataSourceId) {
    ...
    public CourseV2 setCourseId(String courseId) {
    ...
    public CourseV2 setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CourseV2 setDescription(String description) {
    ...
    public CourseV2 setCreated(Instant created) {
    ...
    public CourseV2 setModified(Instant modified) {
    ...
    public CourseV2 setOrganization(boolean organization) {
    ...
    public CourseV2 setUltraStatus(UltraStatus ultraStatus) {
    ...
    public CourseV2 setAllowGuests(boolean allowGuests) {
    ...
    public CourseV2 setClosedComplete(boolean closedComplete) {
    ...
    public CourseV2 setTermId(String termId) {
        this.termId = termId;
        return this;
    }
    ...
    public CourseV2 setAvailability(Availability availability) {
    ...
    public CourseV2 setEnrollment(Enrollment enrollment) {
    ...
    public CourseV2 setLocale(Locale locale) {
        this.locale = locale;
        return this;
    }
    ...
    public CourseV2 setHasChildren(boolean hasChildren) {
    ...
    public CourseV2 setParentId(String parentId) {
    ...
    public CourseV2 setExternalAccessUrl(String externalAccessUrl) {
    ...
    public CourseV2 setGuestAccessUrl(String guestAccessUrl) {
