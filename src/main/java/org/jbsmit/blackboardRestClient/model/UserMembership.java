...
public class UserMembership {
    ...
    public UserMembership setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UserMembership setUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public UserMembership setCourseId(String courseId) {
    ...
    public UserMembership setCourse(Course course) {
        this.course = course;
        return this;
    }
    ...
    public UserMembership setChildCourseId(String childCourseId) {
    ...
    public UserMembership setDataSourceId(String dataSourceId) {
    ...
    public UserMembership setCreated(Instant created) {
    ...
    public UserMembership setModified(Instant modified) {
    ...
    public UserMembership setAvailability(Availability availability) {
    ...
    public UserMembership setCourseRoleId(CourseRoleId courseRoleId) {
    ...
    public UserMembership setBypassCourseAvailabilityUntil(Instant bypassCourseAvailabilityUntil) {
    ...
    public UserMembership setLastAccessed(Instant lastAccessed) {
